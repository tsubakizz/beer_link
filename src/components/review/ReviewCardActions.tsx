...
export function ReviewCardActions({ reviewId, beerId }: ReviewCardActionsProps) {
  ...
  return (
    <>
      <div className="flex items-center justify-end gap-2 mt-3 pt-3 border-t border-base-200">
        <Link
